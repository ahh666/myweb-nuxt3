 ...
 * @Date         : 2024-07-22 17:35:17
 * @LastEditors  : Archer<ahh666@qq.com>
 * @LastEditTime : 2024-07-22 17:39:44
 * @FilePath     : \myweb-nuxt3\public\js\gt4.js
...
(function (window) {
  ...
  const random = function () {
    return Number.parseInt(Math.random() * 10000) + (new Date()).valueOf()
  }
  ...
  const GeetestIsLoad = function (fname) {
    ...
    const tagname = fname && tags[fname.split('.').pop()]
